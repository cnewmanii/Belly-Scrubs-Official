...
export default function Calendars() {
  ...
  return (
    <main className="pt-24 pb-16">
      ...
      <section className="px-6 mt-12" data-testid="section-integration-info">
        <div className="max-w-6xl mx-auto">
          <SoapDivider fillClass="text-[#BAD9E5]/15 dark:text-[#BAD9E5]/5" />
          <div className="bg-[#BAD9E5]/15 dark:bg-[#BAD9E5]/5 rounded-2xl p-6 sm:p-8">
            <div className="flex items-start gap-3">
              <Zap className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
              <div>
                <h3 className="font-semibold text-foreground mb-1">Integration Ready</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  This calendar uses a provider pattern that supports both mock and live data sources.
                  Currently showing mock availability. Switch to Live Mode and connect a calendar provider
                  (Square Bookings, Calendly, etc.) by implementing the CalendarProvider interface.
                </p>
              </div>
            </div>
          </div>
